...
namespace CurriculumVitaeApp.Controllers
{
    public class DatosBasicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UsuarioID,Nombre,Descripcion")] DatosBasicos datosBasicos)
        {
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var entidad = await _context.Perfil.FindAsync(realId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string encryptedId, [Bind("Nombre,Descripcion")] DatosBasicos datosBasicos)
        {
            var idUsuario = await getIdUsuario();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    registroEditado.Descripcion = datosBasicos.Descripcion;
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var datosBasicos = await _context.Perfil
